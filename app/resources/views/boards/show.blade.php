<x-app-layout>
    ...
    data-task-criteria
    data-task-criteria-scope="board_{{ $board->id }}"
        ...
        <div class="mx-auto max-w-[1600px] px-6 py-8 lg:px-8">
            ...
            >
                ...
                @foreach($board->columns as $column)
                    @include('boards.partials.column', [
                        'column' => $column,
                        'board' => $board,
                        'editable' => $board->completed == 0,
                        'criteriaActive' => $taskCriteria['active'],
                    ])
                @endforeach
                            ...
                            button.addEventListener(
                                ...
                                async () => {
                                    ...
                                    try {
                                        ...
                                        const data = await sendColumnRequest(
